...
export const Hero = () => {
  return (
    <div className="bg-black text-white bg-[linear-gradient(to_bottom,#000,#200D42_34%,#4F21A1_65%,#A46EB8_82%)] py-[72px] sm:py-24 relative  overflow-clip">
        ...
        <div className="conainer relative">
            <div className="flex items-center justify-center ">
                <a href="#" className="inline-flex gap-3 border py-1 px-2 rounded-lg border-white/30">
                    <span className="bg-[linear-gradient(to_right,#F87AFF,#FB93D0,#FFDD99,#C3F0B2,#2FD8FE)] from-red-500 to-blue-500 text-transparent bg-clip-text">Version 2.0 is here </span>
            ...
            <div className='flex justify-center mt-8'>
                <div className='inline-flex relative '>
                    ...
                    width="200" 
                    alt="" 
                    className="absolute left-[500px] top-[80px] hidden sm:inline" />
                </div>
            </div>
